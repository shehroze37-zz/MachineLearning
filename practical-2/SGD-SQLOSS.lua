...
for i = 1,(#dataTest)[1] do
   ...
   print(string.format("%6.2f", myPrediction[1]))
end
...
--X_1 = data:narrow(2,2,1)
--X_2 = data:narrow(2,3,1)
...
X_W = X * w
Y_NEG = y * -1
--XW_Y = torch.sum(torch.cat(X_W,Y_NEG,2),2)
XW_Y = X_W - y
SQ_LOSS = XW_Y:transpose(1,2) * XW_Y

print('Squared Loss')
print(SQ_LOSS / 10)

NEW_PREDICTION = dataTest * w 
